...
import jdbcLab187.utils.JDBCutil;
...
//			各個符文字串? 相對應值要設定
			preparedStatement.setString(1, "preparedStatement187");
...
//		demoPreparedStatement.insert("ps1872", "187", "187mail.com");
//		demoPreparedStatement.deletById(6);
//		demoPreparedStatement.updatePasswordByName("Dora", "dora");
//		demoPreparedStatement.findAllUser();
		demoPreparedStatement.findUserById(3);
	}
